...
HSLAPixel colorPicker(string s, HSLAPixel d = HSLAPixel(0,0 ,0))
{
    ...
    if(s=="black")
        color = HSLAPixel(0, 0, 0);
    else if (s== "red")
        color = HSLAPixel(0, 1, 0.5);
    else if (s== "blue")
        color = HSLAPixel(240, 1, 0.5);
    else if (s== "green")
        color = HSLAPixel(120, 1, 0.5);
    else if (s == "white")
        color = HSLAPixel(0, 0, 1);
    else
    {
...
int main(int argc, char *argv[]) 
{
    ...
    {
        cout << "Please enter an integer between 1 and 100 for probability." << endl;
        return 0;
    }
