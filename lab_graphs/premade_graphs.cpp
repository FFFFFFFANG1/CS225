...
Graph PremadeGraphs::createChinaMap(bool isWeighted)
{
    ...
    string labels[]
        = {"Beijing", "Shanghai", "Guangzhou", "Hongkong", "Chengdu",
           "Wuhan",   "Shenzhen", "Xian",      "Hangzhou", "Nanjing"};
    ...
    g.insertEdge(vertices[1], vertices[2]);
    g.insertEdge(vertices[2], vertices[5]);
    g.insertEdge(vertices[2], vertices[9]);
    g.insertEdge(vertices[1], vertices[9]);
//{"Beijing", "Shanghai", "Guangzhou", "Hongkong", "Chengdu",
//           "Wuhan",   "Shenzhen", "Xian",      "Hangzhou", "Nanjing"};
    if (isWeighted) {
        g.setEdgeWeight(vertices[4], vertices[3], 1350);
        g.setEdgeWeight(vertices[4], vertices[0], 1660);
        g.setEdgeWeight(vertices[4], vertices[2], 1230);
        g.setEdgeWeight(vertices[0], vertices[3], 1960);
        g.setEdgeWeight(vertices[0], vertices[1], 1060);
        g.setEdgeWeight(vertices[0], vertices[6], 1943);
        g.setEdgeWeight(vertices[3], vertices[6], 60);
        g.setEdgeWeight(vertices[3], vertices[5], 923);
        g.setEdgeWeight(vertices[6], vertices[5], 1096);
        g.setEdgeWeight(vertices[3], vertices[8], 1281);
        g.setEdgeWeight(vertices[6], vertices[1], 1430);
        g.setEdgeWeight(vertices[5], vertices[1], 825);
        g.setEdgeWeight(vertices[5], vertices[7], 752);
        g.setEdgeWeight(vertices[8], vertices[1], 172);
        g.setEdgeWeight(vertices[1], vertices[7], 1382);
        g.setEdgeWeight(vertices[1], vertices[3], 1460);
        g.setEdgeWeight(vertices[8], vertices[4], 1891);
        g.setEdgeWeight(vertices[1], vertices[2], 1459);
        g.setEdgeWeight(vertices[2], vertices[5], 1009);
        g.setEdgeWeight(vertices[9], vertices[1], 297);
        g.setEdgeWeight(vertices[9], vertices[2], 1364);
    }
